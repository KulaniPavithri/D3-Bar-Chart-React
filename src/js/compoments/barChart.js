...
//npm install d3 --save and then import * as d3 from "d3";
...
const BarChart = () => {
    ...
    const creatingBarChart = () => {
        var svgArea = d3.select("#bar-chart").append("svg")
        ...
        let svgData = svgArea.selectAll("rect")
        ...
        const mouseover = (event , d) => {
            ...
            tooltip.style("left", padding + i * barWidth + "px")
        ...
        svgData.on("mouseover", mouseover)
